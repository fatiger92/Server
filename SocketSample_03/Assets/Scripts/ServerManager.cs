...
public class ServerManager : MonoBehaviour
{
    ...
    void OnIncomingData(ServerClient client, string data)
    {
        ...
        else if (data.Contains("&MESSAGE"))
        {
            ...
            Broadcast($"%MESSAGE|{client.clientName} : {msg}", clients);
            return;
        }
        else if (data.Contains("&POSITION"))
        {
            ...
            Broadcast(client, $"%POSITION|{jsonData}", clients);
            return;
        }
        else if (data.Contains("&UNDO"))
        {
            Broadcast("%UNDO", clients);
            return;
        }
        else if (data.Contains("&CLEAR"))
        {
            Broadcast(client, $"%CLEAR", clients);
            return;
        }
    }
